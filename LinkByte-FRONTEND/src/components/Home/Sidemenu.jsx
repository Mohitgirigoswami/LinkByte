...
const Sidemenu = ({ classplus, isMobile, sideMenuRef ,toggle }) => {
  return (
    <div
      ref={sideMenuRef}
      className={
        ...
        classplus +
        (isMobile ? " absolute top-0 left-0 z-50 rounded-r-2xl" : " rounded-l-2xl translate-x-0 max-w-[25vw]")
      }
    ...
    >
      <div  className="m-[5%] grid grid-cols-1 w-[90%] pb-5  border-b-2 border-gray-500">
        ...
        <div className="flex-grow"></div></div>    
